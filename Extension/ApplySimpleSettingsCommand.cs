...
namespace ToolbarTidy
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ApplySimpleSettingsCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("f6ec4c8e-382e-44ab-bce0-3373ed198fdd");
        ...
        public static async Task InitializeAsync(ToolbarTidyExtensionPackage package)
        {
            ...
            Instance = new ApplySimpleSettingsCommand(package, commandService);
        ...
        /// </summary>
        public static ApplySimpleSettingsCommand Instance
        {
            get;
            private set;
        }
        ...
        private async void Execute(object sender, EventArgs e)
        {
            ...
            await package.SimpleUI.ToggleSimpleAsync();
        }
    }
}
